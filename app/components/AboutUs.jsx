...
const StatsCounter = ({ value, suffix = "" }) => {
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
        ...
        <div className="flex flex-col justify-between space-y-12">
          ...
          <p className="text-lg md:text-xl text-gray-600 leading-relaxed max-w-md">
            At our core, we believe in innovation, strategic problem-solving,
            and collaborative partnerships that help bring ideas to life and
        ...
        <div className="flex flex-col justify-between">
          <div className="relative pt-12">
            <h2 className="text-4xl md:text-3xl font-bold leading-[1.2] tracking-tight">
              <WordHighlight
                text="Apex Bridge is a technology solutions company focused on delivering complete, result-driven IT projects.
We work closely with clients to understand business challenges and transform them into scalable digital solutions. Our team handles everything — planning, development, testing, deployment, and ongoing support.

"
              />
              <br />
              <p>
                <WordHighlight text="We don’t just provide resources ." />

                <WordHighlight text="We deliver outcomes." />
              </p>
            </h2>
          </div>

          {/* Stats Grid */}
          <div className="grid grid-cols-3 gap-4 md:gap-8 mt-10 border-t border-gray-100 pt-12">
            <div>
